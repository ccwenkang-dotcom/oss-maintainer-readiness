...
[![Release](https://img.shields.io/github/v/release/ccwenkang-dotcom/oss-maintainer-readiness)](https://github.com/ccwenkang-dotcom/oss-maintainer-readiness/releases/tag/v0.1.1)
...
```bash
python -m pip install "git+https://github.com/ccwenkang-dotcom/oss-maintainer-readiness.git@v0.1.1"
```
...
jobs:
  assess:
    ...
    steps:
      ...
      - uses: ccwenkang-dotcom/oss-maintainer-readiness@v0.1.1
        with:
